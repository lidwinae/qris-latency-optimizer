...
func (u *fakeWorkerTransactionUsecase) ScanQR(req entity.ScanQRRequest) (*entity.TransactionResponse, error) {
	return nil, nil
}

func (u *fakeWorkerTransactionUsecase) ConfirmPaymentAsync(transactionIDStr string) error {
	return nil
}

func (u *fakeWorkerTransactionUsecase) ConfirmPaymentSync(transactionIDStr string) (*entity.TransactionResponse, error) {
	u.confirmed <- transactionIDStr
	return nil, u.err
}

func (u *fakeWorkerTransactionUsecase) GetTransactionStatus(transactionIDStr string) (*entity.TransactionResponse, error) {
	return nil, nil
}
